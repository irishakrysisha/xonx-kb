...
EXTRA_HIDDEN = {
    ...
    # провайдери: ховаємо лише технічний Опис (дамп ключових слів); обов'язкові
    # роль-маркери (Поінт оф контакт / Хто приніс контакт / Партнер) — видимі
    "Провайдери": {SUMMARY_COL},
}
